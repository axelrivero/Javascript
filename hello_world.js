...
// Constantes, usamos snake case en mayus
...
// Undefined
myBool = undefined // Esto no es adecuado, definir una varibale como undefined
console.log(myBool)
/*
Esto nos permite saber que podemos definir una variable donde mas adelante podemos
indicarle algun tipo de dato y valor, pero antes de todo eso, esta como undefined
*/
...
// Ambas funcionan y podrian llamar la funcion ya sea antes o despues del código de la funcion
...
let myMap = new Map([["Axel", 27], ["José", 23], ["Renee", 25]])
myMap.set("Mario", 500)
...
class MyClass { //Sirve para definir algo parecido a POO, asi lo entendi jejeje se usa Upper Camel Case
